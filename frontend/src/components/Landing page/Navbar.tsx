                ...
                <div className="flex justify-between h-16">
                    <div className="flex items-center">
                        <div className="flex-shrink-0 flex items-center">
                            ...
                            <span className="ml-3 text-xl font-bold text-gray-900">HandyTalk</span>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <button onClick={() => navigate("/signin")} className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2 rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 transition-all transform hover:scale-105">
                            Login
                        </button>
                    </div>
