      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-blue-100 mb-8 leading-relaxed">
            Join thousands of healthcare providers and patients who are already experiencing seamless communication through SignHealth.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="bg-white bg-opacity-10 rounded-lg p-6 backdrop-blur-sm">
              ...
              <div className="text-lg font-semibold text-white mb-2">Quick Setup</div>
              <div className="text-blue-100">Get started in under 5 minutes</div>
            </div>
            <div className="bg-white bg-opacity-10 rounded-lg p-6 backdrop-blur-sm">
              <div className="text-3xl mb-2">💬</div>
            ...
            <div className="bg-white bg-opacity-10 rounded-lg p-6 backdrop-blur-sm">
              <div className="text-3xl mb-2">🔒</div>
              <div className="text-lg font-semibold text-white mb-2">HIPAA Compliant</div>
              <div className="text-blue-100">Secure and private communication</div>
            </div>
          </div>
        </div>
      </div>
